...
!macro customHeader
  ...
  LangString migratingExistingData ${LANG_ENGLISH} "Migrating existing VPN4TV data..."
  LangString migratingExistingData ${LANG_SIMPCHINESE} "正在迁移现有 VPN4TV 数据..."
  LangString migratingExistingData ${LANG_TRADCHINESE} "正在遷移現有 VPN4TV 資料..."
  LangString migratingExistingData ${LANG_FARSI} "در حال انتقال داده‌های موجود VPN4TV..."
  LangString migratingExistingData ${LANG_RUSSIAN} "Перенос существующих данных VPN4TV..."
  ...
  LangString stoppingService ${LANG_ENGLISH} "Stopping the VPN4TV service..."
  LangString stoppingService ${LANG_SIMPCHINESE} "正在停止 VPN4TV 守护进程..."
  LangString stoppingService ${LANG_TRADCHINESE} "正在停止 VPN4TV 守護程序..."
  LangString stoppingService ${LANG_FARSI} "در حال توقف سرویس VPN4TV..."
  LangString stoppingService ${LANG_RUSSIAN} "Остановка службы VPN4TV..."

  LangString checkingRunningApplication ${LANG_ENGLISH} "Checking for running VPN4TV applications..."
  LangString checkingRunningApplication ${LANG_SIMPCHINESE} "正在检查运行中的 VPN4TV 应用..."
  LangString checkingRunningApplication ${LANG_TRADCHINESE} "正在檢查執行中的 VPN4TV 應用程式..."
  LangString checkingRunningApplication ${LANG_FARSI} "در حال بررسی برنامه‌های در حال اجرای VPN4TV..."
  LangString checkingRunningApplication ${LANG_RUSSIAN} "Проверка запущенных приложений VPN4TV..."

  LangString closingApplication ${LANG_ENGLISH} "Closing VPN4TV..."
  LangString closingApplication ${LANG_SIMPCHINESE} "正在关闭 VPN4TV 应用..."
  LangString closingApplication ${LANG_TRADCHINESE} "正在關閉 VPN4TV 應用程式..."
  LangString closingApplication ${LANG_FARSI} "در حال بستن VPN4TV..."
  LangString closingApplication ${LANG_RUSSIAN} "Закрытие VPN4TV..."
  ...
  LangString stopServiceFailed ${LANG_ENGLISH} "Failed to stop the VPN4TV service."
  LangString stopServiceFailed ${LANG_SIMPCHINESE} "无法停止 VPN4TV 守护进程。"
  LangString stopServiceFailed ${LANG_TRADCHINESE} "無法停止 VPN4TV 守護程序。"
  LangString stopServiceFailed ${LANG_FARSI} "توقف سرویس VPN4TV ناموفق بود."
  LangString stopServiceFailed ${LANG_RUSSIAN} "Не удалось остановить службу VPN4TV."
  ...
  LangString registeringService ${LANG_ENGLISH} "Registering the VPN4TV service..."
  LangString registeringService ${LANG_SIMPCHINESE} "正在注册 VPN4TV 守护进程..."
  LangString registeringService ${LANG_TRADCHINESE} "正在註冊 VPN4TV 守護程序..."
  LangString registeringService ${LANG_FARSI} "در حال ثبت سرویس VPN4TV..."
  LangString registeringService ${LANG_RUSSIAN} "Регистрация службы VPN4TV..."

  LangString registerServiceFailed ${LANG_ENGLISH} "Failed to register the VPN4TV service (code $1)."
  LangString registerServiceFailed ${LANG_SIMPCHINESE} "无法注册 VPN4TV 守护进程（代码 $1）。"
  LangString registerServiceFailed ${LANG_TRADCHINESE} "無法註冊 VPN4TV 守護程序（代碼 $1）。"
  LangString registerServiceFailed ${LANG_FARSI} "ثبت سرویس VPN4TV ناموفق بود (کد $1)."
  LangString registerServiceFailed ${LANG_RUSSIAN} "Не удалось зарегистрировать службу VPN4TV (код $1)."
  ...
  LangString copyingApplicationFiles ${LANG_ENGLISH} "Copying VPN4TV application files..."
  LangString copyingApplicationFiles ${LANG_SIMPCHINESE} "正在复制 VPN4TV 应用程序文件..."
  LangString copyingApplicationFiles ${LANG_TRADCHINESE} "正在複製 VPN4TV 應用程式檔案..."
  LangString copyingApplicationFiles ${LANG_FARSI} "در حال کپی فایل‌های برنامهٔ VPN4TV..."
  LangString copyingApplicationFiles ${LANG_RUSSIAN} "Копирование файлов приложения VPN4TV..."
  ...
  LangString registerServiceFailedRolledBack ${LANG_ENGLISH} "Failed to register the VPN4TV service (code $1). The installed application was removed.$\r$\n$\r$\n$3"
  LangString registerServiceFailedRolledBack ${LANG_SIMPCHINESE} "无法注册 VPN4TV 守护进程（代码 $1）。已移除安装的应用程序。$\r$\n$\r$\n$3"
  LangString registerServiceFailedRolledBack ${LANG_TRADCHINESE} "無法註冊 VPN4TV 守護程序（代碼 $1）。已移除安裝的應用程式。$\r$\n$\r$\n$3"
  LangString registerServiceFailedRolledBack ${LANG_FARSI} "ثبت سرویس VPN4TV ناموفق بود (کد $1). برنامهٔ نصب‌شده حذف شد.$\r$\n$\r$\n$3"
  LangString registerServiceFailedRolledBack ${LANG_RUSSIAN} "Не удалось зарегистрировать службу VPN4TV (код $1). Установленное приложение удалено.$\r$\n$\r$\n$3"

  LangString registerServiceFailedRollbackFailed ${LANG_ENGLISH} "Failed to register the VPN4TV service (code $1), and automatic removal failed (code $2).$\r$\n$\r$\n$3"
  LangString registerServiceFailedRollbackFailed ${LANG_SIMPCHINESE} "无法注册 VPN4TV 守护进程（代码 $1），且自动移除失败（代码 $2）。$\r$\n$\r$\n$3"
  LangString registerServiceFailedRollbackFailed ${LANG_TRADCHINESE} "無法註冊 VPN4TV 守護程序（代碼 $1），且自動移除失敗（代碼 $2）。$\r$\n$\r$\n$3"
  LangString registerServiceFailedRollbackFailed ${LANG_FARSI} "ثبت سرویس VPN4TV ناموفق بود (کد $1) و حذف خودکار نیز ناموفق بود (کد $2).$\r$\n$\r$\n$3"
  LangString registerServiceFailedRollbackFailed ${LANG_RUSSIAN} "Не удалось зарегистрировать службу VPN4TV (код $1), а автоматическое удаление завершилось ошибкой (код $2).$\r$\n$\r$\n$3"
  ...
  LangString unsafeInstallationConfirmationWarning ${LANG_ENGLISH} "The installer and service will skip path security checks and permission hardening. This can allow another program to replace VPN4TV data or binaries and elevate privileges to SYSTEM."
  LangString unsafeInstallationConfirmationWarning ${LANG_SIMPCHINESE} "安装程序和守护进程将跳过路径安全检查与权限加固。这可能允许其他程序替换 VPN4TV 数据或程序文件并提权到 SYSTEM。"
  LangString unsafeInstallationConfirmationWarning ${LANG_TRADCHINESE} "安裝程式和守護程序將略過路徑安全檢查與權限強化。這可能允許其他程式取代 VPN4TV 資料或程式檔案並將權限提升至 SYSTEM。"
  LangString unsafeInstallationConfirmationWarning ${LANG_FARSI} "نصب‌کننده و سرویس، بررسی امنیت مسیر و ایمن‌سازی مجوزها را نادیده می‌گیرند. این کار ممکن است به برنامه‌ای دیگر اجازه دهد داده‌ها یا فایل‌های VPN4TV را جایگزین کند و سطح دسترسی را به SYSTEM برساند."
  LangString unsafeInstallationConfirmationWarning ${LANG_RUSSIAN} "Установщик и служба пропустят проверку безопасности путей и усиление разрешений. Другая программа сможет подменить данные или файлы VPN4TV и повысить привилегии до SYSTEM."
  ...
  !ifndef BUILD_UNINSTALLER
  LangString resetWorkingDirectoryPrompt ${LANG_ENGLISH} "The VPN4TV service data directory is invalid:$\r$\n$workingDirectory$\r$\nContinuing will delete this directory so the service can recreate it securely. Continue?"
  LangString resetWorkingDirectoryPrompt ${LANG_SIMPCHINESE} "VPN4TV 守护进程数据目录无效：$\r$\n$workingDirectory$\r$\n继续安装将删除此目录，以便守护进程用安全权限重新创建。是否继续？"
  LangString resetWorkingDirectoryPrompt ${LANG_TRADCHINESE} "VPN4TV 守護程序資料目錄無效：$\r$\n$workingDirectory$\r$\n繼續安裝將刪除此目錄，以便守護程序用安全權限重新建立。是否繼續？"
  LangString resetWorkingDirectoryPrompt ${LANG_FARSI} "پوشهٔ دادهٔ سرویس VPN4TV نامعتبر است:$\r$\n$workingDirectory$\r$\nبا ادامه، این پوشه حذف می‌شود تا سرویس آن را با مجوزهای امن دوباره ایجاد کند. ادامه می‌دهید؟"
  LangString resetWorkingDirectoryPrompt ${LANG_RUSSIAN} "Каталог данных службы VPN4TV недействителен:$\r$\n$workingDirectory$\r$\nПри продолжении каталог будет удалён, чтобы служба могла безопасно создать его заново. Продолжить?"

  LangString resettingWorkingDirectory ${LANG_ENGLISH} "Resetting the VPN4TV service data directory..."
  LangString resettingWorkingDirectory ${LANG_SIMPCHINESE} "正在重置 VPN4TV 守护进程数据目录..."
  LangString resettingWorkingDirectory ${LANG_TRADCHINESE} "正在重設 VPN4TV 守護程序資料目錄..."
  LangString resettingWorkingDirectory ${LANG_FARSI} "در حال بازنشانی پوشهٔ دادهٔ سرویس VPN4TV..."
  LangString resettingWorkingDirectory ${LANG_RUSSIAN} "Сброс каталога данных службы VPN4TV..."

  LangString resetWorkingDirectoryFailed ${LANG_ENGLISH} "Could not reset the VPN4TV service data directory (code $1). No application files were installed."
  LangString resetWorkingDirectoryFailed ${LANG_SIMPCHINESE} "无法重置 VPN4TV 守护进程数据目录（代码 $1）。尚未安装任何应用程序文件。"
  LangString resetWorkingDirectoryFailed ${LANG_TRADCHINESE} "無法重設 VPN4TV 守護程序資料目錄（代碼 $1）。尚未安裝任何應用程式檔案。"
  LangString resetWorkingDirectoryFailed ${LANG_FARSI} "بازنشانی پوشهٔ دادهٔ سرویس VPN4TV ممکن نشد (کد $1). هیچ فایل برنامه‌ای نصب نشد."
  LangString resetWorkingDirectoryFailed ${LANG_RUSSIAN} "Не удалось сбросить каталог данных службы VPN4TV (код $1). Файлы приложения ещё не устанавливались."
  !endif
  ...
  LangString removingService ${LANG_ENGLISH} "Removing the VPN4TV service..."
  LangString removingService ${LANG_SIMPCHINESE} "正在移除 VPN4TV 守护进程..."
  LangString removingService ${LANG_TRADCHINESE} "正在移除 VPN4TV 守護程序..."
  LangString removingService ${LANG_FARSI} "در حال حذف سرویس VPN4TV..."
  LangString removingService ${LANG_RUSSIAN} "Удаление службы VPN4TV..."

  LangString removeServiceFailed ${LANG_ENGLISH} "Failed to remove the VPN4TV service (code $1).$\r$\n$\r$\n$3"
  LangString removeServiceFailed ${LANG_SIMPCHINESE} "无法移除 VPN4TV 守护进程（代码 $1）。$\r$\n$\r$\n$3"
  LangString removeServiceFailed ${LANG_TRADCHINESE} "無法移除 VPN4TV 守護程序（代碼 $1）。$\r$\n$\r$\n$3"
  LangString removeServiceFailed ${LANG_FARSI} "حذف سرویس VPN4TV ناموفق بود (کد $1).$\r$\n$\r$\n$3"
  LangString removeServiceFailed ${LANG_RUSSIAN} "Не удалось удалить службу VPN4TV (код $1).$\r$\n$\r$\n$3"

  LangString removingData ${LANG_ENGLISH} "Removing VPN4TV data..."
  LangString removingData ${LANG_SIMPCHINESE} "正在移除 VPN4TV 数据..."
  LangString removingData ${LANG_TRADCHINESE} "正在移除 VPN4TV 資料..."
  LangString removingData ${LANG_FARSI} "در حال حذف داده‌های VPN4TV..."
  LangString removingData ${LANG_RUSSIAN} "Удаление данных VPN4TV..."
!macroend
